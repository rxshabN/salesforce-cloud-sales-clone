...
export default function DeleteLeadModal({ open, onOpenChange, leadName, onConfirm }: DeleteLeadModalProps) {
  const handleDelete = () => {
    onConfirm()
    onOpenChange(false)
  }
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl p-0" showCloseButton={false}>
        ...
        <div className="border-b border-gray-200 px-6 py-4 flex items-center justify-between">
          <DialogTitle className="text-xl font-normal text-gray-800">Delete Lead</DialogTitle>
          <button
        ...
        <div className="px-6 py-8">
          <p className="text-center text-gray-700">Are you sure you want to delete this lead?</p>
        </div>
